                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.vendors')}}">Vendors </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> Edit vendor </h4>
                                        ...
                                        <form class="form" action="{{route('admin.vendors.update',$vendor -> id)}}"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        src="{{$vendor  -> logo}}"
                                                        class="rounded-circle  height-250" alt="vendor image ">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> vendor data </h4>
